...
This analysis quantifies surface urban heat island intensity (SUHI) for 2 major cities in Uzbekistan using scientifically defensible remote sensing methods. SUHI is calculated as the difference in land surface temperature (LST) between urban cores and nearby rural rings during the warm season (June-August).
...
- Mean SUHI Day Change: 1.059 ± 0.673°C
- Mean SUHI Night Change: 0.999 ± 0.385°C
- Range Day SUHI Change: 0.583 to 1.535°C
- Range Night SUHI Change: 0.727 to 1.271°C

### City-Level Results

| City | SUHI Day Change (°C) | SUHI Night Change (°C) | Urban Built Change | Rural Built Change |
|------|---------------------|----------------------|------------------|------------------|
| Tashkent | 1.535 | 0.727 | N/A | N/A |
| Nukus | 0.583 | 1.271 | N/A | N/A |
...
**Report Generated**: 2025-08-12 13:24:30
